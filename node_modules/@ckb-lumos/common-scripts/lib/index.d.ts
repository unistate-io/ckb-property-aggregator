...
import common, { LockScriptInfo, CellCollectorConstructor, CellCollectorType } from "./common";
...
declare const _default: {
    ...
    dao: {
        ...
        withdraw: (txSkeleton: import("@ckb-lumos/helpers").TransactionSkeletonType, fromInput: import("@ckb-lumos/base").Cell, fromInfo?: FromInfo | undefined, { config }?: import("@ckb-lumos/helpers").Options) => Promise<import("@ckb-lumos/helpers").TransactionSkeletonType>;
    ...
    locktimePool: {
        ...
        injectCapacityWithoutChange: (txSkeleton: import("@ckb-lumos/helpers").TransactionSkeletonType, fromInfos: FromInfo[], amount: bigint, tipHeader: import("@ckb-lumos/base").Header, minimalChangeCapacity: bigint, { config, LocktimeCellCollector, enableDeductCapacity, }: {
            ...
            LocktimeCellCollector?: CellCollectorConstructor | undefined;
    ...
    sudt: {
        ...
        packAmount: typeof import("./sudt").packAmount;
        unpackAmount: typeof import("./sudt").unpackAmount;
    };
    anyoneCanPay: {
        CellCollector: CellCollectorConstructor;
...
export type { LocktimeCell, MultisigScript, FromInfo, LockScriptInfo, CellCollectorConstructor, CellCollectorType, };
