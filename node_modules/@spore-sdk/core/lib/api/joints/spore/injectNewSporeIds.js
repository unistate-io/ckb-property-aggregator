...
exports.injectNewSporeIds = void 0;
const helpers_1 = require("../../../helpers");
const config_1 = require("../../../config");
function injectNewSporeIds(props) {
    // Env
    ...
    let typeIdGroup = (0, helpers_1.generateTypeIdsByOutputs)(firstInput, outputs.toArray(), (cell) => {
        return !!cell.cellOutput.type && (0, config_1.isSporeScriptSupported)(sporeScript, cell.cellOutput.type);
    });
...
exports.injectNewSporeIds = injectNewSporeIds;
//# sourceMappingURL=injectNewSporeIds.js.map